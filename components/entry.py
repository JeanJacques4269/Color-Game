...
class TextInputVisualizer:
    ...
    of the rendered font_entry using the `.surface` attribute.
    ...
    :param font_object: a pygame.font_entry.Font object used for rendering
    :param antialias: whether to render the font_entry antialiased or not
    :param font_color: color of font_entry rendered
    ...
    @property
    def font_color(self):
        """ Get / set color of rendered font_entry """
    ...
    def font_object(self):
        """ Get / set the font_entry object used to render the text """
